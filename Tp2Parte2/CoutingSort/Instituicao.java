 ...
 * Ordena a variavel codigoMunicipio e depois a variavel sigla
 ...
 */
   public int selecao() {
     ...
     for (int i = 0; i < (n - 1); i++) {
        ...
        for (int j = (i + 1); j < n; j++){
          comp++;
           if (array[menor].getPeriodico() == (array[j].getPeriodico())){
     ...
     return comp;
        ...
        * Ordena a variavel periodico e depois a variavel sigla
        * retorna o numero de comparacoes feitas
        */
         public int countingsort() {
         //Array para contar o numero de ocorrencias de cada elemento
         int[] count = new int[100000];
         Docente[] ordenado = new Docente[n];
         ...
         //Ordenando
         for(int i = n-1; i >= 0; i--){
          		ordenado[count[array[i].getPeriodico()]-1] = array[i];
          		count[array[i].getPeriodico()]--;
          		comp++;
	       }
