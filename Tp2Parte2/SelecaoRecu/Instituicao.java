...
public class Instituicao{
    ...
    for(j = 0; j<nEntrada; j++){
      ...
      /*Laco para acessa a lista e ordenar usando selecao
      * Somar a quantidade de comparacoes
      */
    ...
    Arq.openWrite("591513_selecaorecu.txt","ISO-8859-1");
