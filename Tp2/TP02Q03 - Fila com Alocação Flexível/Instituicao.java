 ...
 */
class Celula {
    public Docente elemento; // Elemento inserido na celula.
     ...
     */
    public Celula(Docente elemento) {
      this.elemento = elemento;
      this.prox = null;
    }
}
...
class Fila {
     ...
     * @param x Docente elemento a inserir.
     */
    public void inserir(Docente x) {
     ...
     */
    public Docente remover() throws Exception {
        if (primeiro == ultimo) {
      ...
      Celula tmp = primeiro;
        ...
        Docente resp = primeiro.elemento;
      tmp.prox = null;
      tmp = null;
        return resp;
    }
    ...
    /*
     *Metodo que mede todas as media da variavel despesa
     *e retorna ela arredondada
    */
    public double mediaSomatorio() {
   double resposta = 0, soma = 0, contador = 0;

   for (Celula i = primeiro.prox; i != null; i = i.prox) {
      soma += i.elemento.getDespesaDocente();
      contador++;
   }
   return resposta = Math.round(soma / (int)contador);
    }
    ...
    */
    ...
    /**
     * Mostra a media dos dos elementos do atributo despesaDocente.
     */
    public void mostrar() {
        MyIO.println(media());
    }
    /*
     *Metodo que percorre o tamanho
     *retorna o tamanho
    */
    public int tamanho(){
      int size = 0;
...
//laco para acessar o arquivo, imprimir seus dados e inserir o arquivo no fim da lista
